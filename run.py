...
if __name__ == '__main__':
    ...
    parser.add_argument('--force-reload-data', action='store_true', help="Force reload the dataset")
    ...
    parser.add_argument('--replace', nargs='+', help="Configuration strings to replace (typically for running a local test without changing the runconfig)")
